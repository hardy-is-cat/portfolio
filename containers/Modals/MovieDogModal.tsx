...
const projectImgData = {
  ...
  carZip: [
    "/images/screenshot/screenshot-carzip-01.png",
    "/images/screenshot/screenshot-carzip-02.png",
    "/images/screenshot/screenshot-carzip-03.png",
    "/images/screenshot/screenshot-carzip-04.png",
  ],
  taing: [
  ...
  return (
    <>
      ...
      <DlBlock>
        <div>
          <dt>소개</dt>
          <dd>TMDB 영화정보 api를 이용한 영화정보 조회 및 리뷰 작성 서비스</dd>
        </div>
        <div>
          <dt>진행기간</dt>
