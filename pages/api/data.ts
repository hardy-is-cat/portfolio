...
export const galleryModalContent: GalleryModalTypes = {
  ...
  zual: {
    ...
    description:
      "zual은 조정현입니다. 고등학교때 친구가 멍때리는 모습을 보고 침 좔좔 흘릴것 같다고 해서 붙여진 별명인데, 마음에 들어서 계속 쓰고 있습니다.<br/>사진 찍는걸 좋아하고 필름카메라도 좋아합니다. 저번 여름엔 스노클링의 재미를 알아 잡은 조개로 또 이것저것 해먹었습니다.<br/>집에서 음악 듣고 게임 하는 것도 좋아합니다. 인생게임은 몬스터헌터라고...25년에 신작 나오는 게임인데 정말 재밌답니다...🥺",
  },
};
